...
var RulersGuides = function (evt, dragdrop) {
    ...
    evt.attach('mousedown', document, function (e) {
        ...
        if (
            ...
            guide = document.getElementById(gUid);

            dragdrop.set(guide, {mode: mode});
